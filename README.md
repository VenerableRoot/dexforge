...
<h1 align="center">
  <br>
  <img src="https://raw.githubusercontent.com/VenerableRoot/dexforge/main/.github/banner.svg" alt="DEXFORGE" width="600">
  <br>
</h1>
...
```bash
curl -s https://raw.githubusercontent.com/VenerableRoot/dexforge/main/install.sh | bash
```
...
curl -s https://raw.githubusercontent.com/VenerableRoot/dexforge/main/docker-compose.yml -o docker-compose.yml
docker compose up -d
```
...
```bash
# Clone the repo
git clone https://github.com/VenerableRoot/dexforge.git
cd dexforge
...
**Disassemblers**
- Ghidra 12.0.4
- IDA Pro 9.3 support (use your own licensed install)
- radare2 6.1.0
- Cutter 2.4.1
...
|---|---|
| **⚡ Recommended** | Ghidra, JADX, Apktool, SigTool, uber-apk-signer, radare2, Objection |
...
```
aurora_weather_5.4.2  ->  aurora
```
Output becomes `aurora_decompiled.zip` with clean folder names.
...
Download the full RE toolkit from [Releases](https://github.com/VenerableRoot/dexforge/releases/tag/v1.0):

```bash
# Download and extract tools
cd /opt
wget https://github.com/VenerableRoot/dexforge/releases/download/v1.0/ghidra-12.0.4.tar.gz
wget https://github.com/VenerableRoot/dexforge/releases/download/v1.0/radare2-6.1.0.tar.gz
# ... extract each
```
...
<p align="center">
  ...
  <br><br>
  <a href="https://github.com/VenerableRoot/dexforge/issues">Report Bug</a> •
  <a href="https://github.com/VenerableRoot/dexforge/issues">Request Feature</a>
</p>
